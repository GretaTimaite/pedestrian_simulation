...
2. Density (including Voronoi diagram, a method to partition space, so that each agent has an associated cell) which is measured by counting heads per area;
